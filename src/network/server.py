            ...
            if client_msg[0]:
                ...
                if client_msg[1] == 'game_instruction':
                    ...
                    # if user wants to create fleet
                        ...
                        # when user says that he's done, he can give another instruction - f.e. to shoot
                        while not placed_ships:
                        ...
                        if placed_ships:
                            ...
                            self.send_to_client(conn, 'invalid_instruction', 'You first have to create your fleet!')
